      ...
      <div class="hidden w-full xl:block xl:w-1/2 bg-indigo-50">
        <div class="py-17.5 px-26 text-center">
          <router-link class="mb-5.5 inline-block" to="/">
            <img class="hidden dark:block zengarden-logo" src="../../assets/images/logo/logo-light.png" alt="Logo" />
            <img class="dark:hidden zengarden-logo" src="../../assets/images/logo/logo-light.png" alt="Logo" />
          </router-link>
