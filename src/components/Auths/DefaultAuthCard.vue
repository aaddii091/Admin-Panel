      ...
      <div class="hidden w-full xl:block xl:w-1/2 bg-indigo-50">
        <div class="py-17.5 px-26 text-center">
          <router-link class="mb-5.5 inline-block" to="/">
            <img class="hidden dark:block zengarden-logo" src="../../assets/images/logo/Zengarden Logo-28.png" alt="Logo" />
            <img class="dark:hidden zengarden-logo" src="../../assets/images/logo/Zengarden Logo-28.png" alt="Logo" />
          </router-link>

          <p class="font-medium 2xl:px-20">Login to Your Emotional Headquarters</p>

          <span class="mt-15 inline-block">
            <img src="../../assets/images/illustration/Signin-picture.png" alt="illustration" class="sign-in-image" />
          </span>
        </div>
      </div>
