    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      >
        <div class="relative drop-shadow-2">
          <img src="@/assets/images/logo/user.png" alt="profile" id="profilePic" />
          <label
            for="profile"
      ...
      <div class="mt-4">
        ...
        <div class="mx-auto max-w-180">
          <h4 class="font-medium text-black dark:text-white mt-2">About Me</h4>
          <p class="mt-3.5 text-sm font-normal">
