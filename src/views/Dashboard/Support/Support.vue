...
import TicketList from '@/components/Tables/TicketList.vue'
      ...
      <div class="pr-7">
          <router-link to="/support/raiseTicket">
            <button
              type="button"
              :disabled="loading"
              class="flex gap-x-2 w-sm cursor-pointer rounded-full border border-primary bg-primary py-1 pl-4 p-4 font-medium text-white transition hover:bg-opacity-90 disabled:opacity-50 items-center"
            >
              <svg
                width="26"
                height="26"
